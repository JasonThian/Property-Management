...
function preview_invoice(show){
	...
	if(show){
		...
		for (i = 0; i < descriptions.length; i++) {
			...
			inv.innerHTML += '<div style="position:absolute;left:48.19px;top:334.52px" class="cls_009"><span class="cls_009">'+descriptions[i].value+'</span></div><div style="position:absolute;left:242.46px;top:334.52px" class="cls_010"><span class="cls_010">1</span></div><div style="position:absolute;left:303.67px;top:334.52px" class="cls_010"><span class="cls_010">$0.00</span></div><div style="position:absolute;left:368.22px;top:334.52px" class="cls_010"><span class="cls_010">RM '+prices[i].value+'</span></div><div style="position:absolute;left:441.66px;top:334.52px" class="cls_010"><span class="cls_010">$0.00</span></div><div style="position:absolute;left:506.21px;top:334.52px" class="cls_010"><span class="cls_010">$0.00</span></div>';
